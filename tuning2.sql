...
CREATE OR REPLACE PROCEDURE GENERATE_ORD_BASE (P_GEN_AMOUNT NUMBER, P_COMMIT_NUM NUMBER)
IS
    V_QUOTIENT      NUMBER;
    V_REMAINDER     NUMBER;
...
CREATE OR REPLACE PROCEDURE INSERT_ORD_ITEM (P_GEN_AMOUNT NUMBER, P_COMMIT_NUM NUMBER)
IS
    V_QUOTIENT      NUMBER;
    V_REMAINDER     NUMBER;
